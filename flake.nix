...
# along with this program.  If not, see <https://www.gnu.org/licenses/>.
{
  ...
  inputs = rec {
    ...
    pythoneda-external-artf-flakeutils = {
      ...
      url = "github:pythoneda-external-artf-def/flakeutils/0.0.27";
    };
    pythoneda-external-artf-nixpkgs = {
      ...
      inputs.pythoneda-shared-pythonlang-domain.follows =
        "pythoneda-shared-pythonlang-domain";
      url = "github:pythoneda-external-artf-def/nixpkgs/0.0.25";
    };
    pythoneda-shared-nix-flake-shared = {
      inputs.flake-utils.follows = "flake-utils";
      inputs.nixpkgs.follows = "nixpkgs";
        ...
        pythoneda-shared-pythonlang-artf-banner-for = { python
          ...
          in python.pkgs.buildPythonPackage rec {
            ...
            postInstall = with python.pkgs; ''
              ...
              for dep in ${pythoneda-external-artf-flakeutils} ${pythoneda-external-artf-nixpkgs} ${pythoneda-shared-nix-flake-shared} ${pythoneda-shared-pythonlang-banner} ${pythoneda-shared-pythonlang-domain}; do
